...
Write-Host "4. Deploying to Cloud Run with 1 min-instance for instant warm loading..."
gcloud run deploy ecommerce-backend --image asia-south1-docker.pkg.dev/ecommerce-502707/ecommerce-repo/ecommerce-backend:latest --region asia-south1 --platform managed --allow-unauthenticated --min-instances 1
